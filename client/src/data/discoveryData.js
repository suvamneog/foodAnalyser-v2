...
export const CATEGORIES = [
  {
    id: "high-protein",
    label: "High protein",
    blurb: "≥15 g protein / 100 g from IFCT & INDB",
  ...
  },
  {
    ...
    blurb: "Curated lacto-veg dishes with verified codes",
    examples: ["Paneer", "Dal", "Sabzi", "Roti"],
    icon: "Salad",
    accent: "from-ink-950/90 via-ink-950/55 to-amber-900/20",
    image: "/foods/dhokla.jpg",
  },
  {
    id: "vegan",
    label: "Plant-based dishes",
    blurb: "Curated plant dishes — no meat, egg, or dairy",
  ...
  },
  {
    ...
    blurb: "Homestyle staples with verified IFCT/INDB codes",
    examples: ["Roti", "Dal", "Rajma", "Khichdi"],
    icon: "Utensils",
    accent: "from-ink-950/90 via-ink-950/55 to-orange-900/25",
    image: "/foods/rajma-chawal.jpg",
  },
  {
    id: "street-food",
    label: "Street food",
    blurb: "Common chaat & fried snacks — check kcal honestly",
    examples: ["Samosa", "Vada", "Pav bhaji", "Chaat"],
    icon: "Store",
    accent: "from-ink-950/90 via-ink-950/55 to-yellow-900/20",
    image: "/foods/poha.jpg",
  },
  {
    id: "breakfast",
    label: "Breakfast plates",
    blurb: "Common breakfast dishes with verified codes",
  ...
  },
  {
    id: "snacks",
    label: "Snacks",
    blurb: "Snack-style foods — compare macros before logging",
    examples: ["Sprouts", "Fruit", "Murmura", "Chikki"],
    icon: "Apple",
    accent: "from-ink-950/90 via-ink-950/55 to-stone-800/40",
    image: "/foods/snacks-nuts.jpg",
  },
];

export function getCategoryById(id) {
  const key = String(id || "").toLowerCase();
  const alias = key === "weight-loss" ? "lower-calorie" : key;
  return CATEGORIES.find((c) => c.id === alias) || null;
}
