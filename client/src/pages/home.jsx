...
<div className="w-full z-20 flex flex-col items-center bg-neutral-900/80 pb-4 min-h-[280px] sm:min-h-[300px]"> {/* Added fixed min-height */}
  ...
  >
    How to Use?
        ...
        <div className="w-full px-3 sm:px-4 md:px-0 mt-3">
          <FoodAnalyzer
            output={output}
            loading={loading}
